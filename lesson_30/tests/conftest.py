...
from lesson_30.pages.main_page import MainPage
from lesson_30.pages.my_profile_page import MyProfile
from lesson_30.tests.tests_data import registration_query
from lesson_30.pages.registration_modal import RegistrationModal
...
@pytest.fixture
@allure.step("Check for successful registration - user is redirected to My Profile page")
